...
{
    [V1ApiController]
    public class ManualImportController : ReadarrRestController<ManualImportResource>
    {
        ...
        [HttpPut]
        public IActionResult UpdateItems([FromBody] List<ManualImportResource> resource)
        {
