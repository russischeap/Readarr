...
namespace Readarr.Api.V1.Queue
{
    ...
    public class QueueDetailsController : ReadarrRestControllerWithSignalR<QueueResource, NzbDrone.Core.Queue.Queue>,
                               IHandle<QueueUpdatedEvent>, IHandle<PendingReleasesUpdatedEvent>
    {
        ...
        private List<QueueResource> GetQueue()
        {
            ...
            {
                return fullQueue.Where(q => q.Author?.Id == int.Parse(authorIdQuery.ToString())).ToResource(includeAuthor, includeBook);
            }
